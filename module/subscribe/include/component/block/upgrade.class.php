 ...
 * @version 		$Id: upgrade.class.php 6637 2013-09-12 13:33:06Z Fern $
 */
	...
	public function process()
	{
		...
		if (($aPackage['default_cost'] != '0.00' || $aPackage['recurring_period'] != 0) && $iPurchaseId)
		{
			$this->setParam('gateway_data', array(
					...
					'alternative_cost' => (isset($aPackage['price'][0]) ? serialize($aPackage['price'][0]) : ''),
					'alternative_recurring_cost' => (isset($aPackage['recurring_price'][0]) ? serialize($aPackage['recurring_price'][0]) : '')
				)
			);
		}	
	}
