...
class linkedin extends openinviter_base
	...
	protected $api_key='AVcg-WVWOehWLJHyRHiGVmlS6qomhiPrSAMYMf9YX527uLYRXtIaNLWNanepUKD1';
    protected $secret_key = 'xwmR1-hQhoG1TpGSiJVYnqPqSi8xT0z9V12EUxWk0L3gmsE3aR1D7HM_Y536RXSG';
	...
	public function login($user,$pass)
		...
		$res=$this->post("https://api.linkedin.com/uas/oauth/requestToken");
        echo $res;
		if ($this->checkResponse("initial_get",$res))
			$this->updateDebugBuffer('initial_get',"https://api.linkedin.com/uas/oauth/requestToken",'GET');
		else
			{
