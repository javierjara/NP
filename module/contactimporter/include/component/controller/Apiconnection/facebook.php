...
class Facebook
{
   ...
   */
  public function getLoginUrl($params=array(),$current_domain = null) {
    $currentUrl = $this->getCurrentUrl($current_domain);
    return $this->getUrl(
      'www',
      'login.php',
      array_merge(array(
   ...
   */
  protected function getCurrentUrl($current_domain = null) {
