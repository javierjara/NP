 ...
 * @version 		$Id: im.class.php 6243 2013-07-12 11:32:20Z Raymond_Benc $
 */
...
{	
	...
	public function getChat($iId, $bStatic = true)
	{
		...
		$aChat = $this->database()->select('i.im_id, i.parent_id, ls.user_id AS is_logged_in, ib.user_id AS is_blocked_user, ' . Phpfox::getUserField())
			->from($this->_sTable, 'i')
