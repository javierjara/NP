<upgrade>
	<phpfox_update_pages>
		<page>
			...
			<has_bookmark>1</has_bookmark>
			<parse_php>1</parse_php>
			<add_view>0</add_view>
			<full_size>1</full_size>
			<title>mobile.mobile</title>
			<title_url>mobile-info</title_url>
			<added>1267628853</added>
			<keyword />
			<description />
			...
			<text_parsed><![CDATA[<?php /* Cached: August 18, 2011, 11:08 am */ ?>
