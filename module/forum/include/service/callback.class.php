 ...
 * @version 		$Id: callback.class.php 6140 2013-06-24 17:30:10Z Raymond_Benc $
 */
class Forum_Service_Callback extends Phpfox_Service 
{
	...
	{
		$aRow = $this->database()->select('ft.thread_id, ft.title, l.type_id as like_type_id, ft.group_id, ft.user_id, fp.total_like, fpt.text_parsed AS text, ft.time_stamp, l.like_id AS is_liked, fp.post_id')
			->from(Phpfox::getT('forum_thread'), 'ft')
