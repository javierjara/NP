 ...
 * @version 		$Id: api.class.php 5147 2013-01-16 09:43:00Z Raymond_Benc $
 */
class User_Service_Api extends Phpfox_Service 
{
	...
	public function status($iLinkId = 0)
	{
		...
		*/		
		...
		{
			$this->database()->select('lik.like_id AS is_liked, ')->leftJoin(Phpfox::getT('like'), 'lik', 'lik.type_id = \'user_status\' AND lik.item_id = p.status_id AND lik.user_id = ' . Phpfox::getUserId());
		}
