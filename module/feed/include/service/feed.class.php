 ...
 * @author  		Raymond Benc
 * @package  		Module_Feed
 * @version 		$Id: feed.class.php 6663 2013-09-20 08:05:08Z Fern $
 */
...
{	
	...
	public function get($iUserid = null, $iFeedId = null, $iPage = 0, $bForceReturn = false)
	{
		...
		if (Phpfox::getParam('ad.multi_ad') && $iFeedId == null && Phpfox::isModule('ad') && ( ($iAd = Phpfox::getService('ad')->getSponsoredFeed()) != false))
		{
