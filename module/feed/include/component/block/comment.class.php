 ...
 * @author  		Raymond Benc
 * @package  		Module_Feed
 * @version 		$Id: comment.class.php 6650 2013-09-16 10:58:34Z Raymond_Benc $
 */
class Feed_Component_Block_Comment extends Phpfox_Component 
{
	...
	public function process()
	{
		...
		if ((!PHPFOX_IS_AJAX || $bForceLoad) && $sFeedType == 'view' && Phpfox::getParam('comment.load_delayed_comments_items'))
		{
			// Prepare the param
