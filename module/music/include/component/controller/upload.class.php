 ...
 * @version 		$Id: upload.class.php 6488 2013-08-22 07:36:12Z Miguel_Espinoza $
 */
		...
		else 
		{
				...
				if ($oValidator->isValid($aVals))
				{
					...
					else 
					{
						...
						else
						{
							...
							echo 'window.parent.alert(\'' . implode('<br />', Phpfox_Error::get()) . '\');';
							echo "</script>";
							exit;
						}
					}
			...
			{	
				...
				else
				{
					...
					echo 'alert(\'' . implode('<br />', Phpfox_Error::get()) . '\');';
					exit;
				}
			}
		}
