 ...
 * @package 		Phpfox
 * @version 		$Id: sponsor.html.php 6390 2013-07-31 09:26:41Z Miguel_Espinoza $
 */
...
<form action="{permalink module='ad.sponsor' id=$iId}section_{$sModule}/{if isset($aForms.where)}where_{$aForms.where}/{/if}{if isset($aForms.item_id)}item_{$aForms.item_id}/{/if}" name="js_form" method="post">
