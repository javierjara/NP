 ...
 * @author			Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: minimize.class.php 6528 2013-08-29 09:38:17Z Miguel_Espinoza $
 */
    ...
    public function minify($aFiles, $sVersion, $bIsJS = true, $bDoInit = false, $bReturn = false, $bReplaceUrl = true)
    {
        ...
        else
        {
            ...
            else
            {
				...
				$sHomeThemePath = 'http://' . Phpfox::getParam('core.host') . Phpfox::getParam('core.folder') . 'theme';
